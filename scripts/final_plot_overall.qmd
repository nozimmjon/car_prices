...
overall_growth <- ggplot(overall_index, aes(x = date, y = overall_index)) +
  ...
  # Bottom curve pointing to the intersection at (2024-07-01)
   annotate("curve",
  ...
  labs(title = "Маҳаллий автомобиллар нарх индекси",
       ...
       caption = "Манба:Иқтисодий тадқиқотлар ва ислоҳотлар маркази томонидан очиқ сайтларда берилган эълонлар асосида ҳисобланган.",
       x = NULL,
       y = NULL
       )+
  scale_x_date(
